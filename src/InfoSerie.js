            ...
            <header style={masterHeader}>
                <div className="h-100" style={{ background: 'rgba(0,0,0,0.7)'}}>
                    ...
                    <div className="row h-100 align-items-center">
                        <div className="col-3">
                            <img alt={'Poster ' + data.name} className="img-fluid img-thumbnail" src={data.poster}/>
                        </div>
                        <div className="col-8">
            ...
            <div className="container">
                ...
                <form>
                    ...
                    <div className="form-group">
                        ...
                        <input type="email" value={form.name} onChange={onChange('field')} className="form-control" id="exampleInputEmail1" placeholder="Título da série"/>
                    </div>
                    <div className="form-group">
                        <label htmlFor="name">Comentários</label>
                        <input type="email" value={form.comments} onChange={onChange('comments')} className="form-control" id="exampleInputEmail1" placeholder="Título da série"/>
                    </div>
                    <div className="form-group">
